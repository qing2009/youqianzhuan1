...
import com.shanqb.myTool.utils.NetworkUtils;
import com.shanqb.myTool.utils.SharedPreConstants;
import com.shanqb.myTool.utils.SharedPreferencesUtil;
import com.shanqb.myTool.utils.StringUtils;
import com.shanqb.myTool.utils.LoginUtils;
        ...
        try {
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, loginUrl, new Response.Listener<String>() {
                ...
                protected Map<String, String> getParams() throws AuthFailureError {
                    ...
                    map.put(ActionConstants.VERSION_CODE, "1.0.1");
                    return map;
                }
            };
