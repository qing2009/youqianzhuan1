package com.shanqb.demo.yuwanhezi;
...
import com.shanqb.demo.utils.sdk.YuWanUrlUtil;
 ...
 * 淘金H5 Demo
 */
public class H5ActivityOptYuWan extends Activity {
    ...
    private void setWebChromeClient(){
        webView.setWebChromeClient(new WebChromeClient(){
            ...
            public void openFileChooser(ValueCallback<Uri> filePathCallback, String acceptType, String capture) {
                picUtil = new WebChoosePicUtil(H5ActivityOptYuWan.this,filePathCallback,null);
                picUtil.choicePic();
            }
            // For Android  >= 5.0
            @Override
            public boolean onShowFileChooser(WebView webView,
                ...
                picUtil = new WebChoosePicUtil(H5ActivityOptYuWan.this,null,filePathCallback);
                picUtil.choicePic();
                return true;
            }
        });
    ...
    private void addWebJavascriptInterface(){
        webView.addJavascriptInterface(new Object(){
            ...
            public void openApp(String packageName) {
                ...
                AppUtil.openApp(H5ActivityOptYuWan.this,packageName);
            }
            @JavascriptInterface
        ...
        if(Build.VERSION.SDK_INT>= Build.VERSION_CODES.Q){
            ...
            PermissionUtil.requestPermissions(this, 110 , new String[]{Manifest.permission.READ_PHONE_STATE}, new PermissionUtil.OnPermissionListener() {
                ...
                public void onPermissionDenied() {
                    PermissionUtil.showTipsDialog(H5ActivityOptYuWan.this);
                }
            });
        }
    }
...
//        String baseUrl = "https://app.91taojin.com.cn/";
        String baseUrl = "https://yuwan.xinliangxiang.com/?";
        String appId = "65";
...
//        String url = UrlUtil.buildUrl(getApplicationContext(),userId,oaid,baseUrl,appId,appKey);
        String url = YuWanUrlUtil.buildUrl(getApplicationContext(),userId,oaid,baseUrl, getIntent().getStringExtra("appid"),getIntent().getStringExtra("appkey"));
        Log.e("tag","url=="+url);
        webView.loadUrl(url);
    }
